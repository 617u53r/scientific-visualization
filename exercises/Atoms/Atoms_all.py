...
legendActor.SetEntryString(0,'0.37')
legendActor.SetEntryColor(0, 1.0, 1.0, 1.0)
legendActor.SetEntryString(1,'0.68')
legendActor.SetEntryColor(1, 1.0, 1.0, 0.0)
legendActor.SetEntryString(2,'0.73')
legendActor.SetEntryColor(2, 0.0, 0.0, 1.0)
legendActor.SetEntryString(3,'0.74')
legendActor.SetEntryColor(3, 1.0, 0.0, 0.0)


legendActor.SetPosition(0.01,0.01)
